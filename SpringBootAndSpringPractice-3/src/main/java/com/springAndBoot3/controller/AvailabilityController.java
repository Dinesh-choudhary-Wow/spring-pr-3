...
public class AvailabilityController {
	...
	@PostMapping("/check")
	public ResponseEntity<Object> checkRoomAvailability(@RequestBody AvailabilityRequest availabilityRequest) {
		try {
			...
			System.out.println("hellooooooooooooooooooooooooo from checkRoomAvailability");
